...
const STRINGS: Record<Lang, Strings> = {
  en: {
    ...
    "team.role.master": "Senior Stylist · Founder",
    "team.role.senior": "Colour Specialist",
    "team.role.barber": "Stylist",
    ...
    "svc.womens.name": "Women's Cut",
    "svc.womens.desc": "Precision cut, consultation and blow-dry.",
    "svc.mens.name": "Men's Cut",
    "svc.mens.desc": "Scissor or clipper cut with a sharp finish.",
    "svc.kids.name": "Kids Cut (under 12)",
    "svc.kids.desc": "Patient, careful work for young clients.",
    "svc.blowdry.name": "Blow-dry & Style",
    "svc.blowdry.desc": "Wash, blow-dry and styling for any occasion.",
    "svc.root.name": "Root Colour",
    "svc.root.desc": "Single-process root touch-up, wash and blow-dry.",
    "svc.balayage.name": "Balayage",
    "svc.balayage.desc": "Hand-painted lights, gloss, cut and blow-dry.",
    "svc.cutcolour.name": "Cut + Colour",
    "svc.cutcolour.desc": "Full colour and precision cut, finished and styled.",
    "svc.treatment.name": "Bond Treatment",
    "svc.treatment.desc": "Strengthening in-chair treatment — add to any service.",
    "svc.book": "Book →",
  },
  el: {
    ...
    "team.role.master": "Senior Stylist · Ιδρύτρια",
    "team.role.senior": "Colour Specialist",
    "team.role.barber": "Stylist",
    ...
    // Service catalog
    "svc.womens.name": "Γυναικείο κούρεμα",
    "svc.womens.desc": "Precision cut, consultation, blow-dry.",
    "svc.mens.name": "Αντρικό κούρεμα",
    "svc.mens.desc": "Με ψαλίδι ή μηχανή, καθαρό τελείωμα.",
    "svc.kids.name": "Παιδικό (έως 12)",
    "svc.kids.desc": "Προσεκτική δουλειά, πολλή υπομονή.",
    "svc.blowdry.name": "Blow-dry & styling",
    "svc.blowdry.desc": "Λούσιμο, στέγνωμα και styling.",
    "svc.root.name": "Βαφή ρίζας",
    "svc.root.desc": "Ανανέωση ρίζας, λούσιμο, στέγνωμα.",
    "svc.balayage.name": "Balayage",
    "svc.balayage.desc": "Hand-painted ανταύγειες, gloss, κούρεμα και styling.",
    "svc.cutcolour.name": "Κούρεμα + βαφή",
    "svc.cutcolour.desc": "Πλήρης βαφή και precision cut.",
    "svc.treatment.name": "Bond treatment",
    "svc.treatment.desc": "Ενισχυτική θεραπεία — σε οποιαδήποτε υπηρεσία.",
    "svc.book": "Κλεισε →",
  },
};
